...
Context for Codex. Read this first every session. Keep it updated as the project evolves.
...
**Phase 6.4 in progress.** See `HANDOFF.md` for current state and next steps.
