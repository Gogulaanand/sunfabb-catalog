...
const hasDirectContact =
  hasPhone || Boolean(whatsappHref) || hasEmail || hasAddress;

// LocalBusiness JSON-LD uses the owner-approved public brand identity. It is
// not a claim that the brand name is the legal entity name; that legal fact is
// intentionally not inferred from the supplied contact details.
const jsonLd =
  hasAddress && (hasPhone || hasEmail)
    ? {
        ...
        address: {
          ...
          addressLocality: 'Chennimalai',
          addressRegion: 'Tamil Nadu',
          postalCode: '638051',
          addressCountry: 'IN',
        },
        ...(hasHours ? { openingHours: 'Mo-Sa 09:00-18:00' } : {}),
        url: SITE.url,
      }
    : null;
  ...
  return (
    <div className="max-w-(--spacing-container-max) mx-auto px-5 md:px-(--spacing-margin-desktop) py-12">
      ...
      <nav
        ...
        className="mb-8 text-body-sm text-on-surface-variant"
      >
      ...
      <p className="text-body-sm text-on-surface-variant mb-10 max-w-xl">
        We&apos;d love to hear from you — whether it&apos;s a bulk order
        enquiry, a custom design, or just a question about our products.
      </p>
